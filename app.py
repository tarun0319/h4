...
'ULTRACEMCO.NS','UPL.NS','WIPRO.NS'])
  ...
  if (choose_stock == "ADANIPORTS.NS"):
    ...
    #load the model
    model = load_model("Stock_Data/ADANIPORTS.NS1.model",compile = False)
...
################################################################################################################3
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/AXISBANK.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
########################################################################################5
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/BAJAJFINSV.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
################################################################################6
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/BAJFINANCE.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##########################################################################################################7
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/BHARTIARTL.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##############################################################################################9
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/BRITANNIA.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
########################################################################################10
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/CIPLA.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
#######################11
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/COALINDIA.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
########################12
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/DIVISLAB.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###################13
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/DRREDDY.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
############14
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/EICHERMOT.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
#####15
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/GAIL.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
############16
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/GRASIM.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###################17
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HCLTECH.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##################18
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HDFC.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
################19
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HDFCBANK.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
########20
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HDFCLIFE.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##################21
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HEROMOTOCO.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
#######22
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HINDALCO.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##########23
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/HINDUNILVR.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
######24
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/ICICIBANK.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##########25
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/INDUSINDBK.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###########26
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/INFY.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###27
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/IOC.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
#####28
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/ITC.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####29
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/JSWSTEEL.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
##30
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/KOTAKBANK.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####31
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/LT.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####32
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/M&M.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###33
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/MARUTI.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####34
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/NESTLEIND.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####35
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/NTPC.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####36
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/ONGC.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####37
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/POWERGRID.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####38
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/RELIANCE.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####39
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/SBIN.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
#####40
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/SBILIFE.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####41
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/SHREECEM.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####42
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/SUNPHARMA.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###43
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/TATAMOTORS.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####44
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/TATASTEEL.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####45
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/TCS.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####46
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/TECHM.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####47
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/TITAN.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
###48
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/ULTRACEMCO.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####49
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/UPL.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
...
####50
    ...
    X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
    #load the model
    model = load_model("Stock_Data/WIPRO.NS1.model",compile = False)
    #Get the predicted scaled price
    pred_price = model.predict(X_test)
    #undo the scaling 
    pred_price = scaler.inverse_transform(pred_price)
